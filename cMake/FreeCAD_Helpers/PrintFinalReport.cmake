...
message(STATUS "Qt6Network:          ${Qt6Network_VERSION}")
message(STATUS "Qt6Xml:              ${Qt6Xml_VERSION}")
message(STATUS "Qt6XmlPatterns:      ${Qt6XmlPatterns_VERSION}")
else()
...
message(STATUS "Qt5XmlPatterns:      ${Qt5XmlPatterns_VERSION}")
    ...
    elseif(BUILD_GUI AND BUILD_QT6)
        message(STATUS "Qt6Widgets:          ${Qt6Widgets_VERSION}")
        message(STATUS "Qt6PrintSupport:     ${Qt6PrintSupport_VERSION}")
        message(STATUS "Qt6OpenGL:           ${Qt6OpenGL_VERSION}")
        message(STATUS "Qt6Svg:              ${Qt6Svg_VERSION}")
        message(STATUS "Qt6UiTools:          ${Qt6UiTools_VERSION}")
        message(STATUS "Qt6Concurrent:       ${Qt6Concurrent_VERSION}")
    ...
    if(DEFINED Shiboken6_FOUND)
        message(STATUS "Shiboken6:           ${Shiboken6_VERSION} [${Shiboken6_DIR}] [${SHIBOKEN_INCLUDE_DIR}]")
    else(DEFINED Shiboken6_FOUND)
        message(STATUS "Shiboken6:           not found")
    endif(DEFINED Shiboken6_FOUND)
    if(DEFINED PySide6_FOUND)
        message(STATUS "PySide6:             ${PySide6_VERSION} [${PYSIDE_INCLUDE_DIR}]")
        if(NOT PYSIDE_INCLUDE_DIR)
            message(STATUS " IncludeDir:         Unable to find, python version mismatch?")
        endif(NOT PYSIDE_INCLUDE_DIR)
    else(DEFINED PySide6_FOUND)
        message(STATUS "PySide6:             not found")
    endif(DEFINED PySide6_FOUND)
    if(DEFINED PYSIDE2_TOOLS_FOUND)
        message(STATUS "PySide6Tools:        [${PYSIDE2UICBINARY}] [${PYSIDE2RCCBINARY}]")
    else(DEFINED PYSIDE2_TOOLS_FOUND)
        message(STATUS "PySide6Tools:        not found")
